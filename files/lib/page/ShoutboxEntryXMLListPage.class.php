...
class ShoutboxEntryXMLListPage extends AbstractPage {
	...
	public function show() {
		...
		foreach ( $this->entries as $entry ) {
			...
			echo "<styledUsername><![CDATA[" . StringUtil::escapeCDATA ( $entry->getStyledUsername () ) . "]]></styledUsername>";
			echo "<username><![CDATA[" . StringUtil::escapeCDATA ( $entry->username ) . "]]></username>";
